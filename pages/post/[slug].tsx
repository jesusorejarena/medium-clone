...
function Post({ post }: Props) {
  ...
  return (
    <main>
      ...
      <hr className="max-x-lg my-5 mx-auto border border-yellow-500" />

      {submitted ? (
        <div className="my-10 mx-auto flex max-w-2xl flex-col bg-yellow-500 p-10">
          <h3 className="text-3cl font-bold">
